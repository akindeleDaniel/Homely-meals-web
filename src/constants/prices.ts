...
export const isProtein = (value: string): value is Protein => {
  return value in PROTEIN_PRICES;
};

export const isCombo = (value: string): value is Combo => {
  return value in COMBO_PRICES;
};
